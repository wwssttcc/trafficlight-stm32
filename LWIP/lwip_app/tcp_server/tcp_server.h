...
#define TCP_SERVER_RX_BUFSIZE	1500		//定义tcp server最大接收数据长度
#define TCP_SERVER_TX_BUFSIZE	300		//定义tcp server最大接收数据长度

#define TCP_SERVER_PORT			8899	//定义tcp server的端口
