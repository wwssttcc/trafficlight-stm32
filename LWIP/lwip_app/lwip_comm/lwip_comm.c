...
void lwip_comm_default_ip_set(__lwip_dev *lwipx)
{
	...
	//默认远端IP为:172.200.10.1
	lwipx->remoteip[0]=172;	
	lwipx->remoteip[1]=200;
	lwipx->remoteip[2]=10;
	lwipx->remoteip[3]=1;
...
u8 lwip_comm_init(void)
{
	...
	{
		lwipdev.ip[0] = data.ip[0];
		lwipdev.ip[1] = data.ip[1];
		lwipdev.ip[2] = data.ip[2];
		lwipdev.ip[3] = data.ip[3];
		lwipdev.netmask[0] = data.mask[0];
		lwipdev.netmask[1] = data.mask[1];
		lwipdev.netmask[2] = data.mask[2];
		lwipdev.netmask[3] = data.mask[3];
		lwipdev.gateway[0] = data.gateway[0];
		lwipdev.gateway[1] = data.gateway[1];
		lwipdev.gateway[2] = data.gateway[2];
		lwipdev.gateway[3] = data.gateway[3];
		lwipdev.mac[0] = data.mac1[0];
		lwipdev.mac[1] = data.mac1[1];
		lwipdev.mac[2] = data.mac1[2];
		lwipdev.mac[3] = data.mac1[3];
		lwipdev.mac[4] = data.mac2[0];
		lwipdev.mac[5] = data.mac2[1];
	}
#if LWIP_DHCP		//使用动态IP
	ipaddr.addr = 0;
	netmask.addr = 0;
